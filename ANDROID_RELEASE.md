...
```text
android-release/xibanyalife-1.0.6-7-release.aab
```

已生成的通用 Android 安装包：

```text
android-release/xibanyalife-1.0.6-7-release.apk
```

已生成的市场上传压缩包：

```text
android-release/xibanyalife-android-1.0.6-7-upload-package.zip
```
